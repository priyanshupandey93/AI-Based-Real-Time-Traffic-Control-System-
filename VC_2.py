...
cv2.namedWindow('VC_2 - Single Road Vehicle Counter', cv2.WINDOW_NORMAL)
cv2.resizeWindow('VC_2 - Single Road Vehicle Counter', 640, 360)
print("=" * 60)
print("SINGLE ROAD VEHICLE COUNTER - VC_2.py")
print("=" * 60)
...
while True:
    ...
    cv2.imshow('VC_2 - Single Road Vehicle Counter', small)
